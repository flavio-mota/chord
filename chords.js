...
var NameProvider = ["Faixa 2 A","Faixa 3 A", "Faixa 2 R", "Faixa 1 E", "Faixa 2 E", "Faixa 2 C", "Faixa 1 N", "Faixa 2 N"];
	
var matrix = [
	   [  0,   0,   6,   1,   5,   6,   2,   4],
       [  0,   0, 104,   4, 100, 104,  63,  41],
       [  6, 104,   0,   5, 105, 110,  65,  45],
       [  1,   4,   5,   0,   0,   5,   2,   3],
       [  5, 100, 105,   0,   0, 105,  63,  42],
       [  6, 104, 110,   5, 105,   0,  65,  45],
       [  2,  63,  65,   2,  63,  65,   0,   0],
       [  4,  41,  45,   3,  42,  45,   0,   0]
];

var colors = ["#234AED", "#D97E79", "#7ABDD4", "#E3F03F", "#1FC80B", "#FE7EFA", "#FA8112", "#FC3D0D"];
